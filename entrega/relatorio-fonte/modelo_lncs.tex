...
\titlerunning{zLecture Notes in Computer Science: Authors' Instructionsz}
...
\toctitle{zzz Notes in Coemputer Science}
\tocauthor{zzz' Instructions}
\maketitle
...
\begin{figure}
\centering
\includegraphics[height=6.2cm]{mapa_recor}
